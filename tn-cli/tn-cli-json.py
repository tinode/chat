...
def pop_from_output_queue():
    if tn_globals.OutputQueue.empty():
        return False
    sys.stdout.write(""+tn_globals.OutputQueue.get())
    sys.stdout.flush()
    return True
...
def handle_ctrl(ctrl):
    ...
    #stdoutln("" + str(ctrl.code) + " " + ctrl.text + topic)
