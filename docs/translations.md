...
The translations are located in two places: [/src/i18n/](https://github.com/tinode/webapp/src/i18n/) and [/service-worker.js](https://github.com/tinode/webapp/service-worker.js).
...
A single file needs to be translated: [/tinode/tindroid/app/src/main/res/values/strings.xml](https://github.com/tinode/tindroid/app/src/main/res/values/strings.xml)
