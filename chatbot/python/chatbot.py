...
from tinode_grpc import model_pb2 as pb
from tinode_grpc import model_pb2_grpc as pbx
...
APP_VERSION = "1.2.2"
LIB_VERSION = "2.34.1"  # pkg_resources.get_distribution("tinode_grpc").version
...
def subscribe(topic):
    ...
    add_future(
        tid,
        {
            ...
            "onerror": lambda topicName, errcode: subscription_failed(
                topicName, errcode
            ),
        },
    )
