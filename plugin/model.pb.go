...
type ClientAcc struct {
	...
	Login bool `protobuf:"varint,6,opt,name=login" json:"login,omitempty"`
	// Indexable tags for user discovery
	Tags []string `protobuf:"bytes,7,rep,name=tags" json:"tags,omitempty"`
	// User initialization data when creating a new user, otherwise ignored
	Desc *SetDesc `protobuf:"bytes,8,opt,name=desc" json:"desc,omitempty"`
}
...
type ClientAcc_IsNew struct {
	IsNew bool `protobuf:"varint,2,opt,name=is_new,json=isNew,oneof"`
}
type ClientAcc_UserId struct {
	UserId string `protobuf:"bytes,3,opt,name=user_id,json=userId,oneof"`
}
...
type ClientDel struct {
	Id    string         `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	Topic string         `protobuf:"bytes,2,opt,name=topic" json:"topic,omitempty"`
	What  ClientDel_What `protobuf:"varint,3,opt,name=what,enum=plugin.ClientDel_What" json:"what,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
