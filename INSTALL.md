...
* Deploy as a **StatefulSet** only. Deployments are rejected at startup because their random pod-name suffixes break the worker-ID stability that snowflake ID generation requires.
