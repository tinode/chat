...
const (
	defaultDSN      = "root:@tcp(localhost:5432)/tinode?parseTime=true"
...
func (a *adapter) Open(jsonconfig string) error {
	if a.db != nil {
		return errors.New(a.driver + "Adapter is already connected")
	}
	...
	if err = json.Unmarshal([]byte(jsonconfig), &config); err != nil {
		return errors.New(a.driver + "adapter failed to parse config: " + err.Error())
	}
	...
	a.db, err = sqlx.Open(a.driver, a.dsn)
	if err != nil {
		return err
	}
...
func (a *adapter) CreateDb(reset bool) error {
	...
	a.db, err = sqlx.Open(a.driver, cfg.FormatDSN())
	if err != nil {
		return err
	}
