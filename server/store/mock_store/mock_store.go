...
func (m *MockMessagesPersistenceInterface) Save(msg *types.Message, attachments []string, readBySender bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", msg, attachments, readBySender)
	ret0, _ := ret[0].(error)
	return ret0
}

// Save indicates an expected call of Save.
func (mr *MockMessagesPersistenceInterfaceMockRecorder) Save(msg, attachments, readBySender interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockMessagesPersistenceInterface)(nil).Save), msg, attachments, readBySender)
}
