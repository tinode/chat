...
func (m *MockMessagesPersistenceInterface) Save(msg *types.Message, readBySender bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockMessagesPersistenceInterfaceMockRecorder) Save(msg, readBySender interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockMessagesPersistenceInterface)(nil).Save), msg, readBySender)
}
