...
type Rec struct {
	...
	Features Feature
	// Slice where tags generated by this authentication record are added to.
	Tags []string
	// Authenticator may request the server to create the account.
	// These are the account parameters which can be used for creating the account.
	DefAcs  *types.DefaultAccess
	Public  interface{}
	Private interface{}
}
