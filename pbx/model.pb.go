...
func (x *FileUpResp) GetCtrl() *ServerCtrl {
	if x != nil {
		return x.Ctrl
	}
	return nil
...
type FileDownReq struct {
	...
	// ETag
	IfModified string `protobuf:"bytes,3,opt,name=if_modified,json=ifModified,proto3" json:"if_modified,omitempty"`
}
...
type FileDownResp struct {
	...
	Meta *FileMeta   `protobuf:"bytes,2,opt,name=meta,proto3" json:"meta,omitempty"`
	// Types that are assignable to Message:
	//	*FileDownResp_Content
	//	*FileDownResp_RedirUrl
	Message isFileDownResp_Message `protobuf_oneof:"Message"`
}
...
func (x *FileDownResp) GetCtrl() *ServerCtrl {
	if x != nil {
		return x.Ctrl
	}
	return nil
...
func (m *FileDownResp) GetMessage() isFileDownResp_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *FileDownResp) GetContent() []byte {
	if x, ok := x.GetMessage().(*FileDownResp_Content); ok {
		return x.Content
	}
	return nil
}
...
func (x *FileDownResp) GetRedirUrl() string {
	if x, ok := x.GetMessage().(*FileDownResp_RedirUrl); ok {
		return x.RedirUrl
	}
	return ""
}

type isFileDownResp_Message interface {
	isFileDownResp_Message()
}

type FileDownResp_Content struct {
	// File bytes.
	Content []byte `protobuf:"bytes,3,opt,name=content,proto3,oneof"`
}

type FileDownResp_RedirUrl struct {
	// File location.
	RedirUrl string `protobuf:"bytes,4,opt,name=redir_url,json=redirUrl,proto3,oneof"`
}

func (*FileDownResp_Content) isFileDownResp_Message() {}

func (*FileDownResp_RedirUrl) isFileDownResp_Message() {}
...
var file_model_proto_rawDesc = []byte{
	...
	0x61, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x63, 0x0a, 0x08, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65,
	...
	0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x74, 0x61, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x65, 0x74, 0x61, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x6e, 0x0a, 0x09, 0x46,
	...
	,
	...
	0x04, 0x52, 0x4f, 0x4f, 0x54, 0x10, 0x1e, 0x2a, 0x38, 0x0a, 0x08, 0x49, 0x6e, 0x66, 0x6f, 0x4e,
	0x6f, 0x74, 0x65, 0x12, 0x06, 0x0a, 0x02, 0x58, 0x31, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x52,
	0x45, 0x41, 0x44, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x52, 0x45, 0x43, 0x56, 0x10, 0x02, 0x12,
	0x06, 0x0a, 0x02, 0x4b, 0x50, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x43, 0x41, 0x4c, 0x4c, 0x10,
	0x04, 0x2a, 0x6f, 0x0a, 0x09, 0x43, 0x61, 0x6c, 0x6c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x06,
	...
	,
...
var file_model_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_model_proto_goTypes = []interface{}{
	...
	(*FileMeta)(nil),          // 48: pbx.FileMeta
	(*FileUpReq)(nil),         // 49: pbx.FileUpReq
	(*FileUpResp)(nil),        // 50: pbx.FileUpResp
	(*FileDownReq)(nil),       // 51: pbx.FileDownReq
	(*FileDownResp)(nil),      // 52: pbx.FileDownResp
	nil,                       // 53: pbx.ClientCred.ParamsEntry
	nil,                       // 54: pbx.SetQuery.AuxEntry
	nil,                       // 55: pbx.ClientPub.HeadEntry
	nil,                       // 56: pbx.ServerCtrl.ParamsEntry
	nil,                       // 57: pbx.ServerData.HeadEntry
	nil,                       // 58: pbx.ServerMeta.AuxEntry
}
var file_model_proto_depIdxs = []int32{
	53, // 0: pbx.ClientCred.params:type_name -> pbx.ClientCred.ParamsEntry
	...
	54, // 9: pbx.SetQuery.aux:type_name -> pbx.SetQuery.AuxEntry
	...
	55, // 16: pbx.ClientPub.head:type_name -> pbx.ClientPub.HeadEntry
	...
	56, // 40: pbx.ServerCtrl.params:type_name -> pbx.ServerCtrl.ParamsEntry
	57, // 41: pbx.ServerData.head:type_name -> pbx.ServerData.HeadEntry
	...
	58, // 49: pbx.ServerMeta.aux:type_name -> pbx.ServerMeta.AuxEntry
	...
	48, // 73: pbx.FileUpReq.meta:type_name -> pbx.FileMeta
	33, // 74: pbx.FileUpResp.ctrl:type_name -> pbx.ServerCtrl
	48, // 75: pbx.FileUpResp.meta:type_name -> pbx.FileMeta
	33, // 76: pbx.FileDownResp.ctrl:type_name -> pbx.ServerCtrl
	48, // 77: pbx.FileDownResp.meta:type_name -> pbx.FileMeta
	28, // 78: pbx.Node.MessageLoop:input_type -> pbx.ClientMsg
	49, // 79: pbx.Node.LargeFileReceive:input_type -> pbx.FileUpReq
	51, // 80: pbx.Node.LargeFileServe:input_type -> pbx.FileDownReq
	...
	50, // 88: pbx.Node.LargeFileReceive:output_type -> pbx.FileUpResp
	52, // 89: pbx.Node.LargeFileServe:output_type -> pbx.FileDownResp
...
func file_model_proto_init() {
	...
	file_model_proto_msgTypes[45].OneofWrappers = []interface{}{
		(*FileDownResp_Content)(nil),
		(*FileDownResp_RedirUrl)(nil),
	}
	type x struct{}
