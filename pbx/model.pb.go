...
var file_model_proto_depIdxs = []int32{
	...
	49, // 9: pbx.SetQuery.aux:type_name -> pbx.SetQuery.AuxEntry
	...
	50, // 16: pbx.ClientPub.head:type_name -> pbx.ClientPub.HeadEntry
	...
	51, // 40: pbx.ServerCtrl.params:type_name -> pbx.ServerCtrl.ParamsEntry
	52, // 41: pbx.ServerData.head:type_name -> pbx.ServerData.HeadEntry
	...
	53, // 49: pbx.ServerMeta.aux:type_name -> pbx.ServerMeta.AuxEntry
	...
	28, // 73: pbx.Node.MessageLoop:input_type -> pbx.ClientMsg
	41, // 74: pbx.Plugin.FireHose:input_type -> pbx.ClientReq
	42, // 75: pbx.Plugin.Find:input_type -> pbx.SearchQuery
	45, // 76: pbx.Plugin.Account:input_type -> pbx.AccountEvent
	44, // 77: pbx.Plugin.Topic:input_type -> pbx.TopicEvent
	46, // 78: pbx.Plugin.Subscription:input_type -> pbx.SubscriptionEvent
	47, // 79: pbx.Plugin.Message:input_type -> pbx.MessageEvent
	38, // 80: pbx.Node.MessageLoop:output_type -> pbx.ServerMsg
	39, // 81: pbx.Plugin.FireHose:output_type -> pbx.ServerResp
	43, // 82: pbx.Plugin.Find:output_type -> pbx.SearchFound
	7,  // 83: pbx.Plugin.Account:output_type -> pbx.Unused
	7,  // 84: pbx.Plugin.Topic:output_type -> pbx.Unused
	7,  // 85: pbx.Plugin.Subscription:output_type -> pbx.Unused
	7,  // 86: pbx.Plugin.Message:output_type -> pbx.Unused
